...
public interface SQLConstants {
    ...
    String RESET_AUTO_INCREMENT_FOR_PRODUCTS_TABLE = "ALTER TABLE " + TABLE_PRODUCTS + " AUTO_INCREMENT = 1";
    String DELETE_ALL_ORDERS = "DELETE FROM " + TABLE_ORDERS;
    String RESET_AUTO_INCREMENT_FOR_ORDERS_TABLE = "ALTER TABLE " + TABLE_ORDERS + " AUTO_INCREMENT = 1";
